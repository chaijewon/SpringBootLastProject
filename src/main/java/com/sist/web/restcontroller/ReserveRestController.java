...
public class ReserveRestController {
  ...
  public ResponseEntity<Map> reserve_food_list(
  ...
  public ResponseEntity<String> reserve_insert(
    @RequestBody ReserveVO vo,
    HttpSession session
  )
  {
	  String res="";
  ...
  public ResponseEntity<List<ReserveVO>> admin_reserve_ok(
  ...
  public ResponseEntity<List<ReserveVO>> mypage_reserve_cancel(
    @RequestParam("no") int no,
    HttpSession session
  )
  {
  ...
  public ResponseEntity<ReserveVO> mypage_reserve_detail(
     @RequestParam("no") int no
  )
  {
